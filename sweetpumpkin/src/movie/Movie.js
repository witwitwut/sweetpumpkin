...
class Movie extends React.Component{
    ...
    render(){
      ...
      // ? er det samme som at skrive en if sætning
      // if release_date er false, const year bliver sat lig med null
      // if release_date er true, const year bliver sat lig med release_date.substring(0,4)
